    ...
    <table>
      ...
      <tr>
        <th v-on:click="toggleSort('date')">pvm
          <column-sort-indicator v-if="local.sort==='date'" v-bind:asc="local.sortAsc"/>
        </th>
        <th v-on:click="toggleSort('odo')">odo
          <column-sort-indicator v-if="local.sort==='odo'" v-bind:asc="local.sortAsc"/>
        </th>
        <th v-on:click="toggleSort('dist')">matka
          <column-sort-indicator v-if="local.sort==='dist'" v-bind:asc="local.sortAsc"/>
        </th>
        <th v-on:click="toggleSort('fuelused')">fuel
          <column-sort-indicator v-if="local.sort==='fuelused'" v-bind:asc="local.sortAsc"/>
        </th>
        <th v-on:click="toggleSort('milage')">kulutus
          <column-sort-indicator v-if="local.sort==='milage'" v-bind:asc="local.sortAsc"/>
        </th>
        <th v-on:click="toggleSort('bike')">bike
          <column-sort-indicator v-if="local.sort==='bike'" v-bind:asc="local.sortAsc"/>
        </th>
        <th v-on:click="toggleSort('info')" class="info">info
          <column-sort-indicator v-if="local.sort==='info'" v-bind:asc="local.sortAsc"/>
        </th>
      </tr>
      </thead>
      <tbody>
      <tr v-for="event in sortEvents(fuelEvents(global.events), local.sort, local.sortAsc)"
          v-bind:key="event.bike + event.odo">
